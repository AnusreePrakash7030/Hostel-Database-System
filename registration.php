...
<body>
    ...
    <div class="container">
        ...
        if (isset($_POST["submit"])) {
           ...
           if (empty($fullName) OR empty($admsn_no) OR empty($password) OR empty($passwordRepeat)) {
           ...
           if (count($errors)>0) {
            ...
            $sql = "INSERT INTO users (full_name, admsn_no, password) VALUES ( ?, ?, ? )";
            $stmt = mysqli_stmt_init($conn);
            $prepareStmt = mysqli_stmt_prepare($stmt,$sql);
            if ($prepareStmt) {
                mysqli_stmt_bind_param($stmt,"sss",$fullName, $admsn_no, $passwordHash);
